...
//@property (nonatomic, strong) CameraShutterButton *cameraShutter; //这个应该是照相
@property (nonatomic, strong) CameraToggleButton *cameraToggle; // 切换摄像头
@property (nonatomic, strong) CameraFlashButton *cameraFlash; //灯的按钮
@property (nonatomic, strong) CameraDismissButton *cameraDismiss; // 取消的按钮
