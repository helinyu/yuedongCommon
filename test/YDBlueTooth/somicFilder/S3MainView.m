...
- (void)addUI{
    ...
    self.scrollV = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 0, SCREEN_WIDTH, SCREEN_HEIGHT)];
    ...
    self.startBtn = [[UIButton alloc]initWithFrame:CGRectMake(SCREEN_WIDTH/2-40, self.hotLab.bottom+30, 80, 40)];
