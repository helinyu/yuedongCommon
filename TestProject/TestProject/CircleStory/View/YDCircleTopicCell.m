...
@implementation YDCircleTopicCell
...
//    if (_model.topicId != model.topicId) {
        _model = model;
        [self.userIcon sd_setImageWithURL:[NSURL yd_URLWithString:model.user.avatar] placeholderImage:[UIImage imageNamed:@"img_head_default"]];
            ...
            switch (sortOfImages) {
                case 0:
                    if (model.images.count == 1) {
                        [self.firstImg sd_setImageWithURL:[NSURL yd_URLWithString:obj] placeholderImage:[UIImage imageNamed:@"img_origin_circle_topic_placeholder_big.jpg"]];
                    } else {
                        [self.firstImg sd_setImageWithURL:[NSURL yd_URLWithString:obj] placeholderImage:[UIImage imageNamed:@"img_origin_circle_topic_placeholder_small.jpg"]];
                    }
                    break;
                case 1: {
                    ...
                    [self.secondImg sd_setImageWithURL:[NSURL yd_URLWithString:obj] placeholderImage:[UIImage imageNamed:@"img_origin_circle_topic_placeholder_small.jpg"]];
                }
                    break;
                case 2: {
                    ...
                    [self.thirdImg sd_setImageWithURL:[NSURL yd_URLWithString:obj] placeholderImage:[UIImage imageNamed:@"img_origin_circle_topic_placeholder_small.jpg"]];
                }
                    break;
