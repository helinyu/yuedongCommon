...
//    通过下表查找对应的链接
    YDCTLinkModel * foundLink = [self linkAtIndex:idx linkArray:data.links];
    return foundLink;
}
...
+ (YDCTLinkModel *)linkAtIndex:(CFIndex)i linkArray:(NSArray *)linkArray {
    YDCTLinkModel *link = nil;
    for (YDCTLinkModel *data in linkArray) {
